...
/*
 ...
 fis = new FileInputStream(xlFilePath);
    ...
    public  String[][] getTableArray1(String FilePath, String SheetName) throws Exception {
        ...
        try { 
			        ...
			        mydata=new String[Rows][Columns];
            	
			        for(int i=0;i<=Rows-1;i++)
			    	{
			    		for(int j=0;j<=Columns-1;j++)
			    		{
			    			mydata[i][j]=getCellData(i,j);
  ...
  /*
  public  void PrintmyTableArray1(String FilePath, String SheetName) throws Exception {
    	
    	
    	String[][] mydata = PutTableArray1(FilePath,SheetName);
